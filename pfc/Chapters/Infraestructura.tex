...
En este trabajo se ha usado para la identificación de puntos de interés, emparejamiento y estimación de movimiento. En la Figura se puede apreciar un ejemplo de su uso en la detección de puntos de interés en un entorno real. %TODO: Comprobar
