...
Con el vector representado, para cada característica detectada el descriptor con SURF contendrá 64 dimensiones. A menor dimensión, mayor velocidad de cómputo y de emparejamiento, pero se consigue menor distinción entre características. Para esto SURF tiene una versión extendida con 128 dimensiones.
...
\begin{figure}[th]
\centering
\includegraphics[scale=0.29]{Figures/gui3.png}
\decoRule
\caption[GUI: Cálculo de emparejamientos]{Paso 3: Cálculo de emparejamientos.}
\label{fig:gui3}
\end{figure}
...
\begin{figure}[th]
\centering
\includegraphics[scale=0.29]{Figures/gui4.png}
\decoRule
\caption[GUI: Estimación de la matriz RT]{Paso 4: Estimación de la matriz RT.}
\label{fig:gui4}
\end{figure}
